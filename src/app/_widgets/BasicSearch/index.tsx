  ...
  return (
    <PreviewSearch.Root>
      <form onSubmit={handleSubmit} className="flex-1">
        <PreviewSearch.Input
          name="query"
          className="w-full px-4 py-3 border border-gray-300 bg-white rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-lg"
      ...
      <PreviewSearch.Content
        className="flex justify-center pt-0 h-[400px] shadow-[2px_5px_5px_5px_rgba(0,0,0,0.3)] transition-opacity	w-[var(--radix-popover-trigger-width)] bg-gray-100 dark:bg-gray-800 z-4"
      >
